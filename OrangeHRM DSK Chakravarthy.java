...
public class OrangeHRMDemo {
	...
	public static void main(String[] args) throws InterruptedException, WriteException, AWTException {
		...
		driver.findElement(By.id("systemUser_userName")).sendKeys("LindaAdmin");
		driver.findElement(By.id("systemUser_password")).sendKeys("Bazzinga@143");
		driver.findElement(By.id("systemUser_confirmPassword")).sendKeys("Bazzinga@143");
		Thread.sleep(1000);
		...
		driver.findElement(By.id("message-to-field")).sendKeys("dskchakravarthy@virtusa.com");
		
		driver.findElement(By.cssSelector("div[role='textbox']")).sendKeys("Selenium Code: \n https://github.com/vivekHB/Selenium/blob/master/OrangeHRMDemo.java");
		...
		System.out.println("Mail Has been sent to the recepient");
		Thread.sleep(3000);
		driver.close();
